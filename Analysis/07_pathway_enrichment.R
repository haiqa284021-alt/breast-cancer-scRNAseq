...
markers_cluster5 <- FindMarkers(bc.seurat.obj, ident.1 = "Neuroendocrine")
...
barplot(ego5, showCategory = 10, title = "GO Enrichment - Cluster 5 (Neuroendocrine)")
...
barplot(ekegg5, showCategory = 10, title = "KEGG Pathways - Cluster 5 (Neuroendocrine)") 
# The same workflow was applied to each annotated cluster
# by changing ident.1 to the corresponding cell type label.
